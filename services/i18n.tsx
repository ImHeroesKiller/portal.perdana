...
const dictionary: Translations = {
  ...
  nav_main_menu: { id: 'Menu Utama', en: 'Main Menu' },
  ...
  home_hero_search_label: { id: 'Cari Lowongan Kerja', en: 'Search Job Vacancies' },
  home_hero_search_hint: {
    id: 'Ketik posisi, lokasi, atau departemen — contoh: tukang, Morowali, operasional',
    en: 'Type role, location, or department — e.g. welder, Morowali, operations',
  },
  ...
  home_search_placeholder: { id: 'Cari posisi, lokasi, atau departemen...', en: 'Search role, location, or department...' },
