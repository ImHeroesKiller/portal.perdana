...
export const VacancyFilterChips: React.FC<VacancyFilterChipsProps> = ({
  ...
  <div className={`${SCROLL_ROW} pb-1 pt-0.5 ${className}`}>
        ...
        return (
          <button
            ...
            className={`group inline-flex min-h-[44px] shrink-0 snap-start items-center gap-2 rounded-2xl border px-3 py-2.5 text-left shadow-sm transition-all duration-200 active:scale-[0.97] ${
              isActive
                ? 'border-[#003087] bg-[#003087] text-white shadow-md ring-2 ring-cyan-400/30'
                : 'border-slate-200 bg-white text-slate-800 hover:border-[#003087]/35 hover:bg-blue-50/50 hover:shadow-md active:bg-[#003087]/10'
            }`}
          >
            <span
